    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('admin', 'Administrador'), ('tecnico', 'Técnico'), ('operador', 'Operador'), ('supervisor', 'Supervisor')], default='operador', max_length=20, verbose_name='Tipo de Usuario')),
                ('telegram_chat_id', models.CharField(blank=True, max_length=100, null=True, verbose_name='Chat ID de Telegram')),
